<aside class="left-side sidebar-offcanvas"> 
  ...
  <section class="sidebar"> 
    ...
    <ul class="sidebar-menu">
      ...
      <li> <a href="<?php echo base_url('admin/Menu');?>"><i class="fa fa-angle-double-right"></i><span>Manage Menus</span> </a> </li>
      ...
      <li> <a href="<?php echo base_url('admin/institute');?>"><i class="fa fa-angle-double-right"></i><span>Manage Institute</span> </a> </li>
      <li> <a href="<?php echo base_url('admin/salary');?>"><i class="fa fa-angle-double-right"></i><span>Manage Salary</span> </a> </li>
      <li> <a href="<?php echo base_url('admin/qualification');?>"><i class="fa fa-angle-double-right"></i><span>Manage Qualification</span> </a> </li>
      ...
      <li> <a href="<?php echo base_url('admin/team_members_type');?>"><i class="fa fa-angle-double-right"></i><span>Manage Team Member Type</span> </a> </li>
      <li> <a href="<?php echo base_url('admin/visa_type');?>"><i class="fa fa-angle-double-right"></i><span>Manage Visa Type</span> </a> </li>
      <li> <a href="<?php echo base_url('admin/pay_umo');?>"><i class="fa fa-angle-double-right"></i><span>Manage Pay UMO</span> </a> </li>
      <li> <a href="<?php echo base_url('promail/admin/?secret=passverification&page=home');?>"><i class="fa fa-angle-double-right"></i><span>Manage Marketing</span> </a> </li>
