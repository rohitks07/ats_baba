            ...
            <table id="example2" class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr id="row_<?php echo $row->ID;?>">
                  ...
                  <td><a href="javascript:;" onClick="load_qualification_edit_form(<?php echo $row->ID;?>);" class="btn btn-success btn-xs">Edit</a>
                   <a href="javascript:delete_qualification(<?php echo $row->ID;?>);" class="btn btn-danger btn-xs">Delete</a></td>
                </tr>
                <?php endforeach; else:?>
                <tr>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              <select class="form-control" name="type" id="type" >
                ...
                <option value="ug_degree">UG Degree</option>
                <option value="pg_degree">PG Degree</option>
