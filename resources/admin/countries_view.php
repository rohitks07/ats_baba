...
<aside class="right-side"> 
  ...
  <section class="content-header">
    <h1> Countries Management System 
      <!--<small>advanced tables</small>--> 
    </h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url('admin/dashboard');?>"><i class="fa fa-dashboard"></i> Home</a></li>
      <!--<li><a href="#">Examples</a></li>-->
      <li class="active">Countries Management</li>
    </ol>
  </section>
  ...
  <?php if($this->session->flashdata('added_action')==true): ?>
      <div class="message-container">
        ...
        <h4>New country has been created successfully.</h4>
      </div>
      </div>
      <?php endif;?>
            ...
            <table id="example2" class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr id="row_<?php echo $row->ID;?>">
                  ...
                  <td><a href="javascript:;" onClick="load_countries_edit_form(<?php echo $row->ID;?>);" class="btn btn-success btn-xs">Edit</a> <a href="javascript:delete_countries(<?php echo $row->ID;?>);" class="btn btn-danger btn-xs">Delete</a></td>
                </tr>
                <?php endforeach; else:?>
                <tr>
