        ...
        <div class="box">
          ...
          <div class="box-body table-responsive">
            <div class="text-right" style="padding-bottom:2px;">
              <input type="button" class="btn btn-primary btn-sm" value="Add New City" onClick="load_cities_add_form();" />
            </div>
                ...
                <tr id="row_<?php echo $row->ID;?>">
                  ...
                  <td><?php
				  		if($row->is_popular=='yes')
							...
							$class_label = 'warning';
				  ?>
                  <a onClick="update_cities_popular(<?php echo $row->ID;?>);" href="javascript:;" id="show_pop_<?php echo $row->ID;?>"> <span class="label label-<?php echo $class_label;?>"><?php echo $row->is_popular;?></span></a></td>
    ...
    <form name="frm_cities" id="frm_cities" role="form" method="post" action="<?php echo base_url('admin/cities/add');?>">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Add New City And State</h4>
        </div>
  ...
  <div class="modal-dialog">
    <form name="frm_cities" id="frm_cities" role="form" method="post" action="<?php echo base_url('admin/cities/update');?>" onSubmit="return validate_edit_cities_form(this)">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          <h4 class="modal-title">Updated City And State</h4>
        </div>
        <div class="modal-body"> 
          <!-- /.box-header --> 
          <!-- form start -->
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <?php echo form_error('edit_city_name'); ?>
            </div>
            <div class="form-group">
                <input type="text" class="form-control"  id="edit_state" name="edit_state" value="<?php echo set_value('state');?>" placeholder="State">
                <?php echo form_error('edit_state'); ?>
            </div>
        </div>
