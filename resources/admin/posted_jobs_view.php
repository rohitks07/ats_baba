            ...
            <table id="example2" class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr id="row_<?php echo $row->ID;?>">
                  ...
                  <td><?php
				  		if($row->sts=='published')
							$class_label = 'success';
						elseif($row->sts=='deleted')
							$class_label = 'danger';
						else
							$class_label = 'warning';
				  ?>
					<a onClick="update_status_model('<?php echo $row->ID;?>','<?php echo $row->job_code ?>','<?php echo $row->sts ?>');" href="javascript:;" id="sts_<?php echo $row->ID;?>"> <span class="label label-<?php echo $class_label;?>"><?php echo camelize($row->sts);?></span> </a></td>
...
<!-- Update Job Status modal section Start --> 
<div class="modal fade" id="job_sts_update">
<form name="job_sts_update_frm" id="job_sts_update_frm" action="">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        <button type="button" name="sts_submit" id="sts_submit" class="btn btn-primary">Update Status</button>
      </div>
    </div>
  </div>
</form>
</div>
<!-- Update Job Status modal section End --> 
