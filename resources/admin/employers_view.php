            ...
            <table id="example2" class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <th style="text-align:center">HQ Location</th>
                  <th style="text-align:center">Jobs</th>
                  <th style="text-align:center">Users</th>
                  <th style="text-align:center">Email Address</th>
                  <th style="text-align:center">Top Employer</th>
                  <th style="text-align:center">Status</th>
                  <th style="text-align:center">Quick Views</th>
              ...
              <tbody>
				...
				if($result):
					foreach($result as $row):
						...
						$total_users = $this->posted_jobs_model->count_records('tbl_team_member','employer_id',$row->ID);
                ...
                <tr id="row_<?php echo $row->ID;?>">
					<td align="left" valign="middle">
						<a href="<?php echo base_url('admin/employers/details/'.$row->ID);?>" target="_blank">
					...
					<td align="center" valign="middle">
						<a class="btn btn-primary btn-xs" href="<?php echo base_url('admin/posted_jobs/jobs_by_company/'.$row->ID);?>" target="_blank"><?php echo $total_posted_jobs;?></a>
					</td>
					<td align="center" valign="middle">
						<a class="btn btn-primary btn-xs" href="<?php echo base_url('admin/users_list/users_by_company/'.$row->ID);?>" target="_blank"><?php echo $total_users;?></a>
					</td>
					...
					<td align="center" valign="middle">
						<?php
							...
							elseif($row->sts=='blocked')
								...
								$class_label = 'warning';
						?>
						<a onClick="update_status(<?php echo $row->ID;?>);" href="javascript:;" id="sts_<?php echo $row->ID;?>">
							<span class="label label-<?php echo $class_label;?>"><?php echo camelize($row->sts);?></span>
						</a>
					</td>
					<td align="center" valign="middle">
						<a href="javascript:;" class="btn btn-primary btn-xs" onClick="load_quick_profile_view('<?php echo $json_string;?>', '<?php echo $total_posted_jobs;?>');">Profile View</a> <!--a href="javascript:;" onClick="load_quick_job_view('<?php echo $row->ID;?>', '<?php echo $row->company_name;?>');" class="btn btn-primary btn-xs">Job View</a-->
					</td>
					<td align="center" valign="middle">
						<a href="<?php echo base_url('admin/employers/update/'.$row->ID);?>" alt="Edit" title="Edit">
							<i class="fa fa-pencil" aria-hidden="true">&nbsp;</i>
						</a>
						<a target="_blank" href="<?php echo base_url('admin/employers/login/'.$row->ID);?>" alt="Login as Employer" title="Login as Employer">
							<i class="fa fa-sign-in" aria-hidden="true"></i>
						</a>
						<a href="javascript:delete_employer(<?php echo camelize($row->ID);?>);" alt="Delete" style="margin-left:2px;" title="Delete">
