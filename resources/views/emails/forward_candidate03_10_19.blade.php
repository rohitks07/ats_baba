...
<tr><td>Skype ID</td><td></td></tr>
<tr><td>LinkedIn ID*</td><td></td></tr>
<tr><td>Current Location (City, State)</td><td></td></tr>
<tr><td>Qualification with University name  and Passing Year</td><td>{{$data['forward_candidate']['qualification1']}}</td></tr>
<tr><td>Visa Status</td><td>{{$data['forward_candidate']['visa_status']}}</td></tr>
<tr><td>US Visa Expiry</td><td></td></tr>
<tr><td>DOB</td><td>{{$data['forward_candidate']['dob']}}</td></tr>
<tr><td>Last 4 digits SSN. No</td><td>{{$data['forward_candidate']['ssn']}}</td></tr>
