        ...
        <div id="wrapper">             
				         ...
				         <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form">
                                            <form class="cmxform form-horizontal tasi-form" id="signupForm" method="post" action="{{url('jobpostform/add')}}" novalidate="novalidate">
						 ...
						 <div class="row">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form">
                                                ...
                                                <div class="col-sm-8">
                                                    <select class="form-control" style="max-width:350px; border: 1px solid #737373" name="Industry">
                                                ...
                                                <div class="col-sm-8">
													<select class="form-control" style="max-width:300px; border: 1px solid #737373" name="state">
									 ...
									 <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <select class="form-control" style="max-width:350px; border: 1px solid #737373" name="OrganizationType">
			              ...
			              <div class="form-group row">
                            <label class="col-sm-4 control-label">Location Time Zone *</label>
                                    <div class="col-sm-8">
                                        <select class="form-control" style="max-width:350px; border: 1px solid #737373" name="locationtimezone">
                            ...
                            <label class="col-sm-4 control-label">Display Time Zone *</label>
                                    <div class="col-sm-8">
                                        <select class="form-control" style="max-width:350px; border: 1px solid #737373" name="displaytimezone">
											<option value="">Select Time Zone</option>
												<option value="(GMT-12:00) International Date Line West">(GMT-12:00) International Date Line West</option>
												<option value="(GMT-11:00) Midway Island, Samoa">(GMT-11:00) Midway Island, Samoa</option>
												<option value="(GMT-10:00) Hawaii">(GMT-10:00) Hawaii</option>
								    ...
								    <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input class="form-control" style="border: 1px solid #737373; width: 84%;" id="company_location" name="company_location1" type="text"><br>
														<input class="form-control" style="border: 1px solid #737373; width: 84%;" id="company_location" name="company_location2" type="text">
			...
			<input type="text" name="city" value="" class="custom-control" Panecholder="City" style="max-width:17%; margin-left: 9px; border: 1px solid #737373;">
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <select class="form-control" style="max-width:350px; border: 1px solid #737373" name="noofemp">
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <textarea class="form-control" style="max-width:84%; border: 1px solid #737373" rows="5" name="company_description" id="example-textarea-input"></textarea>
                                                </div>
                                            </div>
