                               ...
                               <div class="card-body">
									...
									<div class="form-group row">
										<label for="" class="control-label col-lg-4"> First Name </label>
											<div class="col-lg-8">
												<input class="form-control" id="" name="" placeholder="First Name" type="number--" >
											</div>
									  </div>
								<!--end of Name-->
								<!--Last Name-->	   
									<div class="form-group row">
										<label for="" class="control-label col-lg-4"> Last Name </label>
											<div class="col-lg-8">
												<input class="form-control" id="" name="" placeholder="Last Name" type="number--" >
											</div>
									  </div>
								<!--end of Last Name-->
								<!--Full Name-->	   
									<div class="form-group row">
										<label for="" class="control-label col-lg-4"> Full Name </label>
											<div class="col-lg-8">
												<input class="form-control" id="" name="" placeholder="Full Name" type="number--" >
											</div>
									  </div>
								<!--end of Full Name-->
								...
								<!--Email (W)-->	   
									<div class="form-group row">
										<label for="" class="control-label col-lg-4">Email Id <span style="color:red;">*</span> </label>
											<div class="col-lg-8">
												<input class="form-control" id="" name="" placeholder="Email ID" type="number--">
											</div>
									  </div>
								<!--end of Email (W)-->
								...
								<!--end of Add in Contact Database-->
									<div class="form-group">
									    <center><button class="btn btn-info waves-effect waves-light m-b-5" type="submit">Submit</button> </center></a>                                                   </div>																   
                                         </form>                                      
                                    </div> <!-- card-body -->
                                </div> <!-- card -->
                            </div> <!-- col -->
