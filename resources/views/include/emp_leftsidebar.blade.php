    ...
    <div class="sidebar-inner slimscrollleft"><br>
      ...
      <div id="sidebar-menu">
            <ul>
                ...
                <li><a href="{{url('employer/dashboard')}}" class="waves-effect"><i class="fa fa-search"></i><span>  Dashboard </span></a></li>
                <li><a href="{{url('employer/posted_jobs')}}" class="waves-effect"><i class="fa fa-users"></i><span> Jobs</span></a></li>
...
?>
                <li class="has_sub">
                    <a href="#" class="waves-effect subdrop"><i class="fa fa-tasks"></i><span><span> Reports</span><span class="pull-right"><i class="md md-remove"></i></span></a>
                    <ul class="list-unstyled" style="display: block;">
                        <li><a href="{{url('employer/report')}}">View Report</a></li>
                        <li><a href="{{url('employer/manageteammember/team_members_view/send_report/'.$id.'/'.$name)}}">Send Report</a></li>
                    </ul>
                </li>                 
            </ul>
        </div>
