                    ...
                    <div class="col-md-10">
                        <div class="card" style="border: 1px #C0C0C0 solid;">
                            <div class="card-header" style="background-color: #29b6f6;">
		                     <h3 class="card-title" style="color:#fff;text-transform: none; font-size:large">ADD USER</h3></div>
                               <div class="card-body">							   	
									<!--Name-->	   
								...
								<!--Group-->	   						                                  
									 <div class="form-group row">
										<label class="col-sm-4 control-label">Group <span style="color:red;">*</span></label>
											<div class="col-sm-8">
												<select class="form-control" style="max-width:150px; border: 1px solid #737373">													
								...
								<!--Confirm Password-->	   
									<div class="form-group row">
										<label for="" class="control-label col-lg-4">Confirm Password<span style="color:red;">*</span></label>
											<div class="col-lg-8">
												<input class="form-control" id="confirm_pass" name="confirm_pass" placeholder="Confirm Password" type="text">
											</div>
									  </div>
								...
								<!--Mobile Phone-->	   
									<div class="form-group row">
										<label for="" class="control-label col-lg-4">Mobile Phone<span style="color:red;">*</span></label>
											<div class="col-lg-8">
												<input class="form-control" id="mobile_number" name="mobile_number" placeholder="" type="number">
											</div>
									  </div>
								<!--end of Mobile Phone -->
								<!--Home Phone-->	   
									<div class="form-group row">
										<label for="" class="control-label col-lg-4">Home Phone</label>
											<div class="col-lg-8">
												<input class="form-control" id="phone" name="phone" placeholder="" type="number">
											</div>
									  </div>
								<!--end of Home Phone -->
								...
								<!--Location Time Zone-->	   						                                  
									 <div class="form-group row">
										<label class="col-sm-4 control-label">Location Time Zone<span style="color:red;">*</span></label>
											<div class="col-sm-8">
												<select class="form-control" style="max-width:100%; border: 1px solid #737373">													
								...
								<!--Jobs History-->	   						                                  
									 <div class="form-group row">
										<label class="col-sm-4 control-label">Jobs History <span style="color:red;">*</span></label>
											<div class="col-sm-8">
												<select class="form-control" style="max-width:50%; border: 1px solid #737373">													
									...
									<!--start-->											  
										...
										<!--start-->											  
											  <tr>
                                                ...
                                                <td>											
												  <label>
											         <input type="checkbox" data-toggle="toggle">												   												  </label>
												</label>
											  </td>
                                              </tr> 
										<!--end-->											 											  
								...
								<div class="form-group">
									    <center><button class="btn btn-info waves-effect waves-light m-b-5" type="submit">Signup</button> </center></a>                                                   </div>																   
                                         </form>   
                                    </div><!--end of col-->
                                 </div><!--end of row-->
