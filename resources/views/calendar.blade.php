                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header" >
                                    <h3 class="card-title" style="color:white;text-transform: none; font-size:large">
                                        Interviews
                                        <a href="{{url('employer/dashboard/interview-meeting/add')}}"><button type="button" class="btn btn-success"
                                                style="float: right;">Add an Interview</button></a>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header" >
                                    <h3 class="card-title" style="color:white;text-transform: none; font-size:large">
                                        Meetings
                                    <a href="{{url('employer/dashboard/interview-meeting-tab/add')}}"><button type="button" class="btn btn-success"
