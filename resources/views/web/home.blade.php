...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{url('web/assets/images/logo/favicon.png')}}" type="image/x-icon">

    <!-- CSS Files -->
    <link rel="stylesheet" href="{{url('web/assets/css/animate-3.7.0.css')}}">
    <link rel="stylesheet" href="{{url('web/assets/css/font-awesome-4.7.0.min.css')}}">
    <link rel="stylesheet" href="{{url('web/assets/fonts/flat-icon/flaticon.css')}}">
    <link rel="stylesheet" href="{{url('web/assets/css/bootstrap-4.1.3.min.css')}}">
    ...
    <header class="header-area main-header">
        <div class="container">
            <div class="row">
                <div class="col-lg-2">
                    <div class="logo-area">
                        <a href="{{url('index.html')}}"><img src="{{url('web/assets/images/logo.png')}}" alt="logo"></a>
                    </div>
                </div>
                <div class="col-lg-10">
                    ...
                    <div class="main-menu">
                        <ul>
                            ...
                            <li><a href="{{url('job_category')}}">Search job</a></li>
                            <li><a href="#">Search resume</a>
                                <!-- <ul class="sub-menu">
                            ...
                            <li class="menu-btn">
                                <a href="{{url('login')}}" class="login">log in</a> </li>
                                <li class="menu-btn"><a href="#" class="template-btn">sign up</a>
                                <ul class="sub-menu">
                                    <li><a href="{{url('post_a_job')}}">post a job</a></li>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="single-category text-center mb-4">
                        <img src="web/assets/images/cat1.png" alt="category">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-category text-center mb-4">
                        <img src="web/assets/images/cat2.png" alt="category">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-category text-center mb-4">
                        <img src="web/assets/images/cat3.png" alt="category">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-category text-center mb-4">
                        <img src="web/assets/images/cat4.png" alt="category">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-category text-center mb-4 mb-lg-0">
                        <img src="web/assets/images/cat5.png" alt="category">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-category text-center mb-4 mb-lg-0">
                        <img src="web/assets/images/cat6.png" alt="category">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-category text-center mb-4 mb-md-0">
                        <img src="web/assets/images/cat7.png" alt="category">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-category text-center">
                        <img src="web/assets/images/cat8.png" alt="category">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="recent" role="tabpanel" aria-labelledby="home-tab">
                            <div class="single-job mb-4 d-lg-flex justify-content-between">
                                ...
                                <div class="job-img align-self-center">
                                    <img src="web/assets/images/job1.png" alt="job">
                                </div>
                        ...
                        <div class="tab-pane fade" id="full-time" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="single-job mb-4 d-lg-flex justify-content-between">
                                ...
                                <div class="job-img align-self-center">
                                    <img src="web/assets/images/job2.png" alt="job">
                                </div>
                                <div class="job-btn align-self-center">
                        ...
                        <div class="tab-pane fade" id="part-time" role="tabpanel" aria-labelledby="contact-tab">
                            <div class="single-job mb-4 d-lg-flex justify-content-between">
                                ...
                                <div class="job-img align-self-center">
                                    <img src="web/assets/images/job3.png" alt="job">
                                </div>
                                <div class="job-btn align-self-center">
                        ...
                        <div class="tab-pane fade" id="intern" role="tabpanel" aria-labelledby="contact-tab2s">
                            <div class="single-job mb-4 d-lg-flex justify-content-between">
                                ...
                                <div class="job-img align-self-center">
                                    <img src="web/assets/images/job4.png" alt="job">
                                </div>
                                <div class="job-btn align-self-center">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    ...
    <!-- Javascript -->
    <script src="{{url('web/assets/js/vendor/jquery-2.2.4.min.js')}}"></script>
    <script src="{{url('web/assets/js/vendor/bootstrap-4.1.3.min.js')}}"></script>
    <script src="{{url('web/assets/js/vendor/wow.min.js')}}"></script>
    <script src="{{url('web/assets/js/vendor/owl-carousel.min.js'}}"></script>
    <script src="{{url('web/assets/js/vendor/jquery.nice-select.min.js')}}"></script>
    <script src="{{url('web/assets/js/vendor/ion.rangeSlider.js')}}"></script>
