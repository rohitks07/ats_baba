                ...
                <div id="accordion-test" class="card-box">
                    <div class="card mb-0">
                        <div class="card-header" id="headingOne2">
                            <h5 class="m-0 card-title">
                                <a href="#" class="text-dark" data-toggle="collapse" data-target="#collapseOne"
                                    aria-expanded="false" aria-controls="collapseOne">Posted Date
                                </a>
                            </h5>
                        </div>
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne2"
                            ...
                            <div class="card-body">
                                <button type="button" class="btn btn-primary waves-effect waves-light m-b-5 cor">Any
                                    Date</button><br>
                                <button type="button"
                                    class="btn btn-primary waves-effect waves-light m-b-5 cor">Today</button><br>
            ...
            <div class="row">
                <div class="col-md-11">
                    <div class="crd">
                        <div class="row">
                            <div class="col-md-10" style="background-color: #f7f7f7;">
                                <h3 style="color: #069;">{{$list['job_title']}}</h3>
                        ...
                        <div class="row" style="border-bottom: 1px solid #9c9797;">
                            <i class="fa fa-map-marker ft-size" aria-hidden="true"></i>
                            <div class="col-md-10">
                                <p style="font-size: 16px;">{{$list['city']}}&nbsp;{{$list['state']}} &nbsp;
                                    {{$list['country']}} </p>
                            </div>
                        </div>
                        <div class="row" style="margin-top: 8px;">
                            <i class="fa fa-suitcase ft-size" aria-hidden="true"></i> &nbsp;
                            <p style="font-size: 16px;">{{$list['job_mode']}}</p>
                            <i class="fa fa-clock-o ft-size" aria-hidden="true"></i> &nbsp;
                            <p style="font-size: 16px;">50 minutes ago</p>
                        </div>
                        <p style="margin-bottom: 8px; text-align: justify;">{{$list['job_description']}} </p>
                        <div class="col-md-12" style="text-align: right;">
                            <button type="button" class="btn btn-primary">Apply</button>
                        </div>
                    </div>
