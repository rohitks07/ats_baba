        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                        <li class="nav-item">
                                <a class="nav-link" href="{{url($company_record->company_name.'/jobs')}}">Home</a>
                                    </li>
                            ...
                            <center>
                                {{-- <form action="http://hrmssystems.com/job_search" name="jsearch" id="jsearch"
                                    ...
                                    <div class="input-group" style="width: 80%;">
                                        <input type="text" name="" id="search_job" class="form-control"
                ...
                <div id="accordion-test" class="card-box">
                        ...
                        <div class="card-header" id="headingOne2">
                            <h5 class="m-0 card-title">
                                <a href="#" class="text-dark" data-toggle="collapse" data-target="#collapseOne"
                                    aria-expanded="false" aria-controls="collapseOne">Job
                                </a>
                            </h5>
                        </div>

                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne2"
                            data-parent="#accordion-test">
                            <div class="card-body">
                                <button type="button" class="btn btn-primary waves-effect waves-light m-b-5 cor">latest
                                    Selected job</button><br>
                                <button type="button"
                                    class="btn btn-primary waves-effect waves-light m-b-5 cor">
                                    {{$data_from}}</button><br>
                    ...
                    {{-- <div class="card mb-0">
                        <div class="card-header" id="headingTwo2">
                            <h5 class="m-0 card-title">
                                <a href="#" class="text-dark" data-toggle="collapse" data-target="#collapseTwo"
                                    aria-expanded="true" aria-controls="collapseTwo">
                                    Employment Type
                                </a>
                            </h5>
                        </div>
                        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo2"
                            data-parent="#accordion-test">
                            <div class="card-body">
                                <input id="checkbox1" type="checkbox"> &nbsp;<button type="button"
                                    class="btn btn-primary waves-effect waves-light m-b-5 cor"
                                    style="width: 190px;">Full
                                    Time</button><br>
                                <input id="checkbox1" type="checkbox"> &nbsp;<button type="button"
                                    class="btn btn-primary waves-effect waves-light m-b-5 cor"
                                    style="width: 190px;">Contract</button>
                            </div>
                        </div>
                    </div>
                    <div class="card mb-0">
                            ...
                            <div class="card-body">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="example-input1-group2" name="example-input1-group2"
                                        class="form-control" placeholder="meter / Kilometer">
                                    <span class="input-group-prepend">
                                        <button type="button" class="btn waves-effect waves-light btn-primary"><i
                    ...
                    <div class="card mb-0">
                        ...
                        <div id="collapseFour" class="collapse" aria-labelledby="headingThree2"
                            data-parent="#accordion-test">
                            <div class="card-body">
                                <input id="checkbox1" type="checkbox"> &nbsp;<button type="button"
                                    class="btn btn-primary waves-effect waves-light m-b-5 cor"
                                    style="width: 190px;">Direct
                                    Hire</button><br>
                                <input id="checkbox1" type="checkbox"> &nbsp;<button type="button"
                                    class="btn btn-primary waves-effect waves-light m-b-5 cor"
                                    style="width: 190px;">Recruiter</button>
                            </div>
                        </div>
                    </div>
                    <div class="card mb-0">
                        ...
                        <div id="collapseFive" class="collapse" aria-labelledby="headingThree2"
                            data-parent="#accordion-test">
                            <div class="card-body">
                                <input id="checkbox1" type="checkbox"> &nbsp;<button type="button"
                                    class="btn btn-primary waves-effect waves-light m-b-5 cor"
                                    style="width: 190px;">Yes</button>
                            </div>
                        </div>
                    </div> --}}
            ...
            <div class="row">
                <div class="col-md-11">
                    <div class="crd">
                        <div class="row">
                            <div class="col-md-10" style="background-color: #f7f7f7;">
                                <h3 style="color: #069;">{{$data->job_title}}</h3>
                                <h4> {{$data->client_name}} </h4>
                            </div>
                            <div class="col-md-2">
                                <!--<img src="{{url('assets/images/sunweb.png')}}" class="log img img-thumbnail"-->
                                <!--    style="height:100px; width:100px;">-->
                                <img src="{{url('public/companylogo/'.$company_record->company_logo)}}" id="logo_image" class="log img img-thumbnail"
                                    style=" width:70%">
                        ...
                        <div class="row" style="border-bottom: 1px solid #9c9797;">
                            <i class="fa fa-map-marker ft-size" aria-hidden="true"></i>
                            <div class="col-md-10">
                                <p style="font-size: 16px;">{{$data['city']}}&nbsp;{{$data['state']}} &nbsp;
                                    {{$data->country}} </p>
                            </div>
                        </div>
                        <div class="row" style="margin-top: 8px;">
                            <i class="fa fa-suitcase ft-size" aria-hidden="true"></i> &nbsp;
                            <p style="font-size: 16px;">{{$data->job_mode}}</p>
                            {{-- <i class="fa fa-clock-o ft-size" aria-hidden="true"></i> &nbsp;
                            <p style="font-size: 16px;">50 minutes ago</p> --}}
                        </div>
                        <?php
                            @$job_desc = explode('•',$data->job_description);
                        ?>
                        @foreach ($job_desc as $item)
                        <p style="margin-bottom: 8px; text-align: justify;width:80%">{{@$item}} </p>
                        @endforeach
                        <br>

                        <p style="font-size: 16px;">Job duration - {{$data->job_duration}} {{$data->job_duration_uom}}
                        </p>
                        <br>
                        <?php
                            @$visa_explode = explode(',',$data->job_visa_status);
                        ?>
                        <div style="float:left">
                            <div class="row">
                                <div class="col-md-1">
                                    <span style="font-size: 16px;display:inline;">Visa status</span>
                                </div>
                                <div class="col-md-2">
                                    @foreach ($visa_explode as $key => $item)
                                    <span> - &nbsp;{{@$item}}<br></span>
                                    @endforeach
                                </div>
                                <div class="col-md-3" style="border-left:1px solid #D6D6D6">
                                    <p style="font-size: 16px;text-align:center;">Minimum Experience - &nbsp;{{$data->min_experience}}</p>
                                    <?php
                                        @$expode_quallification = explode(',',$data->qualification);
                                    ?>
                                    <div style="text-align:center;">
                                        <p style="font-size: 16px;border:1px solid #D6D6D6;">Qualification</p>
                                        @foreach ($expode_quallification as $item)
                                        <p style="font-size: 16px;"> - {{@$item}}</p>
                                        @endforeach
                                    </div>
                                </div>
                                <div class="col-md-1" style="border-left:1px solid #D6D6D6">
                                    <span style="font-size: 16px;">Skills</span>
                                </div>
                                <div class="col-md-3">
                                    <?php 
                                        @$exploded_skill = explode(',',$data->required_skills);
                                        ?>
                                    @foreach ($exploded_skill as $item)
                                    <span style="font-size: 16px;">- &nbsp;{{@$item}}<br></span>
                                    @endforeach
                                </div>
                            </div>
                        </div>
                    ...
                    $(function () {
                        ...
                        $('.lj-countdown').countdown({
                            ...
                            render: function (data) {
                                $(this.el).html('<div><div><span>' + (parseInt(this
                                            .leadingZeros(data.years, 2) * 365) +
                                        parseInt(this.leadingZeros(data.days, 2))) +
                                    '</span><span>days</span></div><div><span>' + this
