...
<body>
  ...
  <center><div class="row" style="width: 70%; margin-top: 30px;">
    <div class="col-md-6">
      <div><div class="image parbase section">

        <img src="https://www.jamesgmartin.center/wp-content/uploads/2017/06/staff.jpg" alt="Diverse crowd of people standing at a table" class="img img-thumbnail img-responsive" data-emptytext="Image">
...
<!-- Grid row -->
<div class="row">
  <center><div class="col-md-9" style="margin-bottom: 200px;">
  ...
  <center>
    <div class="row" style="width: 65%;">
      <div class="col-md-4" style="font-size: 30px;">
        <i class="fa fa-download" aria-hidden="true"></i> &nbsp; DOWNLOAD CENTER
      </div>
      <div class="col-md-4" style="font-size: 30px;">
        <i class="fa fa-file" aria-hidden="true"></i> &nbsp; PARTNER & SUPPLIER INFO
      </div>
      <div class="col-md-4" style="font-size: 30px;">
       <i class="fa fa-search-plus" aria-hidden="true"></i> &nbsp; DOWNLOAD CENTER
     </div>
   </div></center>
   <hr class="hrr">
   ...
   <center>
    <div class="row" style="width: 65%;">
      <div class="col-md-5" style="margin-top: 12px;">
        Privacy Notice  &nbsp;  &nbsp;Terms of Use   &nbsp;  &nbsp;Website Accessibility Statement
      </div>
      <div class="col-md-3">
