...
<body><br><br><br><br><br>
        <div class="sub-main-w3">
            <div class="bg-content-w3pvt" style="max-width: 40%;height: 480px;">
                ...
                <form method="post" action="{{url('email_link')}}" class="text-center"> 
                    <p class="legend">Forget Link<span class="fa fa-hand-o-down"></span></p>
                    {{ csrf_field()}}
                    ...
                    <div class="form-group m-b-0"> 
                        <center>
                            <div class="input-group" style="width:60%;"> 
                                <input type="email" name="email_id" class="form-control" placeholder="Enter Email" required> <br>   
                            </div>
                        </center> <br>
