                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="row ml-5">
                                                            ...
                                                            <div class="col-md-6 mt-2">
                                                                <div class="form-group">
                                                                        <input type="hidden" name="id_main" id="id" value="{{$data->meeting_ID}}">
                                                                      
                                                                    <input type="date" class="form-control" name="date" id="" 
                                                                aria-describedby="helpId" placeholder="" value="{{$data->meeting_date}}" required>
                                                        ...
                                                        <div class="row ml-5">
                                                            ...
                                                            <div class="col-md-6 mt-2">
                                                                ...
                                                                <input id="timepicker" class="form-control input-small" type="text"
                                                        name="meeting_time" value="{{$data->meeting_time}}" required >
                                                        ...
                                                        <div class="row ml-5">
                                                            ...
                                                            <div class="col-md-6 mt-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    {{-- Drop down --}}
                                                                    <div class="form-group">
                                                                        <select class="form-control" name="local_time" id="" required >
                                                        ...
                                                        <div class="row ml-5">
                                                            ...
                                                            <div class="col-md-6 mt-2">
                                                                ...
                                                                aria-describedby="helpId" placeholder="" value="{{$data->subject}}" required>
                                                                </div>
                                                                <div class="col-md-1">
                                                        ...
                                                        <div class="row ml-5">
                                                            ...
                                                            <div class="col-md-6 mt-2">
                                                                ...
                                                                name="parti" required>{{$data->participants}}</textarea>
