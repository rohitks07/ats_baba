  ...
  <aside class="right-side"> 
    ...
    <section class="content">
     <table width="100%" border="0" align="left">
              ...
              <tr>
                <td width="19%" align="center"><a href="<?php echo url('admin/employers');?>"><i class="fa awesome_style fa-briefcase"></i><br>
                Employers</a></td>
                <td width="19%" align="center"><a href="<?php echo url('admin/job_seekers');?>"><i class="fa awesome_style awesome_style fa-user"></i><br>
                  Jobseeker</a></td>
                <td width="19%" align="center"><a href="<?php echo url('admin/posted_jobs');?>"><i class="fa awesome_style fa-upload"></i> <br>
                  Posted Jobs</a></td>
                <td width="19%" align="center"><a href="<?php echo url('admin/posted_jobs');?>"><i class="fa fa-clipboard awesome_style"></i><br>
                  Featured Jobs</a></td>
                <td width="19%" align="center"><a href="<?php echo url('admin/pages');?>"><i class="fa awesome_style fa-file-text"></i><br>
