                               ...
                               <form action ="{{url('employer/posted_companies/add')}}" method="post"  enctype="multipart/form-data">						   	
									...
									<div class="form-group row">
										...
										<label for="" class="control-label col-lg-4">Company <span style="color:red;">*</span></label>
											<div class="col-lg-8">
												<input type="text" id="" name="company_name" placeholder="Company Name">
											</div>
									  </div>
								<!--end of Company Name-->
								<!--Company Short Name-->	   
									<div class="form-group row">
										<label for="" class="control-label col-lg-4">Short Name <span style="color:red;">*</span></label>
											<div class="col-lg-8">
													<input type="text" id="company_short_name" name="company_short_name" placeholder="Company Short Name">
											</div>
									  </div>
								...
								<!--Federal ID / EIN-->	   
									<div class="form-group row">
										<label for="" class="control-label col-lg-4">Federal ID / EIN </label>
											<div class="col-lg-8">
												<input type="text" id="fed_id" name="fed_id" placeholder="00-0000000">
											</div>
									  </div>
								...
								<!--DUNS-->	   
									<div class="form-group row">
										<label for="" class="control-label col-lg-4">DUNS </label>
											<div class="col-lg-8">
													<input type="text" id="duns" name="duns" placeholder="00-0000000">
											</div>
									  </div>
								<!--end of DUNS-->
								<!--Company Logo-->	   
									<div class="form-group row">
										<label for="" class="control-label col-lg-4">Company Logo</label>
											<div class="col-lg-8">
												<input type="file" class="form-control" name="company_logo" id="company_logo" value="" style="width:55%; background:#fff;">
											</div>
									  </div>
								<!--Company Logo-->
									   ...
									   <!--HQ Location-->				
										<div class="form-group row">
											...
											<select name="country_name" id="country" class="form-control" onChange="grab_cities_by_country(this.value);" style="width:11%; border: 1px solid #737373; margin-left: 9px;background:#fff;">
										...
										<select name="state" id="state_text" class="form-control" onchange="select_city_by_state(this.options[this.selectedIndex].value)" style="max-width:11%;background:#fff; margin-left: 9px; border: 1px solid #737373;">
											 ...
											 @foreach($toReturn['cities'] as $state)
												...
												@endforeach
										          ...
										          <input name="city_name" type="text" class="form-control" id="city" placeholder="City" name="city_name" value="" maxlength="150" style="width:12%; margin-left:1em;background:#fff;">
								...
								<!--State of Organization-->	   						                                  
									 <div class="form-group row">
										<label class="col-sm-4 control-label">State of Organization </label>
											<div class="col-sm-8">
												<select class="form-control" name="organization_state" style="width:34%; border: 1px solid #737373; background:#fff;">													
													<option value="" selected>Select State</option>
											 @foreach($toReturn['cities'] as $state)
												<option  >{{$state['state']}}</option>
												@endforeach									
								...
								<!--Employees-->	   						                                  
									 <div class="form-group row">
										<label class="col-sm-4 control-label">Employees</label>
											<div class="col-sm-8">
												<select class="form-control" name="employer" style="width:34%; border: 1px solid #737373; background:#fff;">													
