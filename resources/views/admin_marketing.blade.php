                        ...
                        <div class="col-md-12">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane show active" id="home-2" role="tabpanel" aria-labelledby="home-tab-2">
                                    <div class="card-body">
                                        <div class="form">
                                            <form class="cmxform form-horizontal tasi-form" id="signupForm" action="{{url('admin/market_mail')}}" method="post">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        ...
                                                        @foreach($toReturn['email_Template'] as $template)
                                                            ...
                                                            <option value="">{{$template->et_sender_name}}</option>
		                                                @endforeach
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <textarea class="wysihtml5 form-control article-ckeditor" name="email_content" id="article-ckeditor45" placeholder="Message body" style="height: 200px" required></textarea>
                                                    </div>
                                                </div>
                                                <div align="center">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="tab-content" >
                            	<div class="tab-pane" id="ContactsList" role="tabpanel" aria-labelledby="profile-tab-2">
                                                    ...
                                                    <tbody>
                                                     @foreach($toReturn['contacts'] as $contact_object)                                         
                                                        ...
                                                        <?php $id=$contact_object->id; ?>
                                                            ...
                                                            <td class="actions">
                                                            <a href="#" data-toggle="modal" data-target="#myModal{{$id}}" class="on-default edit-row" data-toggle="tooltip" data-placement="top" title="" data-original-title="edit"><i class="fa fa-pencil"></i></a>
                                                            <a href="{{url('admin/marketing/contactdelete/'.$id)}}"  class="hidden on-editing login-row" data-toggle="tooltip" data-placement="top" title="" data-original-title="delete"><i class="fa fa-trash-o"></i></a>
                                                            </td>  	                                              																							
                                                        </tr>  
                                                        <!-- The Modal -->
                                                            <div class="modal fade" id="myModal{{$id}}vghv">
                                    ...
                                    <div>
                                            <form action="{{url('admin/marketing/addcontact')}}" method="post">       
                                            <input type="hidden" name="_token" value = "{{ csrf_token()  }}" >                        
                                            <div class="form-group row" style="width: 101%;">
                                            <label class="col-sm-4 control-label">Salutation</label>
                                                <div class="col-sm-8">
                                                    <select class="form-control" name="salutation" style="width:50%; border: 1px solid #737373; background: #fff" required>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                     <input type="text" id="phonew" name="phone_w" placeholder="00.000.000"  maxlength="12" required>
                                                </div>
                                            </div> 
                                        </div>
                                        <!-- <div class="col-md-6">     -->
                                            <div class="form-group row" >
                                                ...
                                                <div class="col-lg-8">
                                                     <input type="email" id="" name="email_h" placeholder="Email ID" maxlength="60" required>
                                                </div>
                                            </div>      
                                            <div class="form-group row">
                                                <label for="" class="control-label col-lg-4">Email (W)</label>
                                                <div class="col-lg-8">
                                                     <input type="email" id="" name="email_w" placeholder="Email ID"  maxlength="60" required>
                                                </div>
                                            </div>              
                                            <div class="form-group row">
                                                <label for="address" class="control-label col-lg-4">Address </label>
                                                <select name="country" id="country" class="form-control"style="width:17%; border: 1px solid #737373; margin-left: 9px; background:#fff;" required>
                                                <option value="" selected>Select Country</option>
                                                @foreach($toReturn['countries'] as $countries)
												    <option>{{$countries['country_name']}}</option>
												@endforeach
                                                </select>
                                                <select name="state" id="state_text" class="form-control"style="max-width:17%; margin-left: 9px; border: 1px solid #737373; background:#fff;" required>
                                                <option value="" selected>Select State</option>
                                                <option value="AK" >AK</option>   
                                                </select>
                                                <input type="text" name="city" class="form-control" id="city" placeholder="City" maxlength="150" style="width:17%; margin-left:1em; background:#fff;" required>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-12">
                                                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                    ...
                                                    <tr>  
                                                        ...
                                                        <td class="actions">
                                                        <a href="{{url('admin/marketing/emaillistdelete/'.$id)}}" class="on-default edit-row" data-toggle="tooltip" data-placement="top" title="" data-original-title="delete"><i class="fa fa-trash-o"></i></a>
                     ...
                     <div class="tab-content" style="width: 100%;">
		           		<div class="tab-pane" id="templates" role="tabpanel" aria-labelledby="templates">
                            <div class="card-body" id="templateslist" style="display:block;">
                                            ...
                                            @foreach($toReturn['email_Template'] as $template)
		                                        ...
		                                        <tr>
                                                    ...
                                                    <a href="" data-toggle="modal" data-target="#" onclick="editTemplate(<?php echo $id; ?>);"  class="on-default edit-row" data-toggle="tooltip" data-placement="top" title="Edit" name="editbtn" data-original-title="Edit"><i class="fa fa-pencil"></i></a>
                                                        <a href="{{url('admin/emailTemplate/delete/'.$id)}}" class="on-default remove-row" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="fa fa-trash-o"></i></a>
                         	...
                         	<div class="card-body" id="templatesform" style="display: none;">
                                <div class="form">
                                    ...
                                    <form class="cmxform form-horizontal tasi-form" id="signupForm" action="{{url('admin/emailTemplate')}}" method="POST">
                                       @csrf()
                                        <div class="form-group row">
                                          	<label for="password" class="control-label col-lg-4">Template Name<span class="red">*</span></label>
                                            <div class="col-lg-8">
                                                <input type="text" placeholder="Template Name" name="templatesname" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <textarea class="wysihtml5 form-control editor" name="email_content" id="editor45" placeholder="Discription " style="height: 200px" required></textarea>
                                            </div>
                                        </div>
                                        <div align="center">
                            ...
                            <div class="card-body" id="edittemplatesform" style="display: none;">
                                <div class="form">
                                <span><button type="button" class="btn btn-primary  waves-effect waves-light pull-right listtemplate" >List Template</button></span><br><br>
                                    <form class="cmxform form-horizontal tasi-form" id="signupForm" action="{{url('admin/emailTemplate/updated')}}" method="POST">
                                       @csrf()
                                        <div class="form-group row">
                                          	<label for="password" class="control-label col-lg-4">Template Name<span class="red">*</span></label>
                                            <div class="col-lg-8">
...
{ 
  ...
  $("#edittemplatesform").css('display','block');
    $.ajaxSetup({
                ...
                $.ajax({
                    url: "{{url('admin/emailTemplate/edit')}}"+'/'+id,
                    type: 'get',
                    dataType: "json",
...
function template_list()
{
    ...
    $.ajaxSetup({
                ...
                $.ajax({
                    url: "{{url('admin/marketing/listtemplate')}}",
                    type: 'get',
                    dataType: "json",
