                            ...
                            <form action="{{url('employer/post_new_candidate/insert')}}" method="post"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <!--Gender-->
                                        <div class="form-group row">
                                            <label class="col-sm-4 control-label">Gender <span
                                                    style="color:red;">*</span></label>
                                            <div class="col-sm-8">
                                                <select class="form-control" name="gender" id="gender"
                                                    style="width:83%; background:#fff;">
                                        ...
                                        <!--Visa-->
                                        <div class="form-group row">
                                            <label class="col-sm-4 control-label">Visa <span
                                                    style="color:red;">*</span></label>
                                            <div class="col-sm-8">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <select name="country" id="country" class="form-control "
                                                style="width:22%; border: 1px solid #bbb8b8; margin-left: 9px;"
                                                required>
                                            ...
                                            <select name="state" id="state_text" class="form-control "
                                                style="max-width:22%; margin-left: 9px; border: 1px solid #bbb8b8;"
                                                required>
                                                <option value="">Select State</option>
                                            </select>
                                            <div class="col-md-12"
                                                style="float: right;margin-left: 21em;margin-top: 2%;">
                                                <div id="select_city">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="file" class="form-control" name="file_other1" id="cv_file2"
                                                    style="background:#fff;" /><br>
                                                <input type="file" class="form-control" name="file_other2" id="cv_file3"
                                ...
                                <center>
                                    <div id="shown">
                                        <button class="btn btn-primary open1" type="button" id="validatefrm">Next <span
                                ...
                                <div class="menun" style="display: none;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="card" style="border: 1px #C0C0C0 solid;">
                                                <div class="card-header" style="background-color: #317eeb;">
                                                    <h3 class="card-title"
                                                        style="color:#fff;text-transform: none; font-size:large">
                                                            ...
                                                            <div class="form-content">
                                                                ...
                                                                <div id="educational_detail">
                                                                    <div class="form-group row delete_row">
                                                                        <label for="address"
                                                                            class="control-label col-lg-12"> </label>
                                                                        <select name="degree[]" id="degree"
                                                                            class="form-control"
                                                                            placeholder="Degree Title"
                                                                            style="width: 14%; margin-left: 9px; border: 1px solid #737373;">
                                                                            <option value="" selected>Select Degree
                                                                            </option>
                                                                        ...
                                                                        <input type="text" name="institute[]"
                                                                            ...
                                                                            placeholder="Institute" style="width: 14%;">
                                                                        <input type="text" name="edu_city[]"
                                                                            id="edu_city" class="form-control"
                                                                            placeholder="City" style="width: 14%;">
                                                                        ...
                                                                        <p><button type="button" id="btnAdd"
                                                                                class="btn btn-primary">Add More&nbsp;<i
                                                                                    class="fa fa-plus"
                                    ...
                                    <center>
                                        <div id="shows">
                                            <button class="btn btn-primary open1" type="button" id="edu_validatefrm"
                                                onclick="check_if_exists()">Next <span
                                                    class="fa fa-arrow-right"></span></button>
                                        </div>
                                    </center><br>
                                                                    ...
                                                                    <div id="exp_detail">
                                                                        <div class="form-group row delete_exp">
                                                                            ...
                                                                            <input type="text" name="company_name[]"
                                                                                ...
                                                                                style="width: 17%;">
                                                                            <input type="text" name="exp_city[]"
                                                                                id="exp_city" class="form-control"
                                                                                placeholder="City" style="width: 14%;">
                                                                            <select type="text" name="exp_country[]"
                                                                                id="exp_country" class="form-control"
                                                                                placeholder="Country"
                                                                                style="width: 14%;">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <input class="form-control"
                                                                        style="border: 1px solid #737373; width:100%;"
    ...
    <script>
        $(document).ready(function () {
            ...
            function val_date() {
                ...
                if (!dob_val_month || !dob_val_year) {
                    $("#check_date").focus();
                    $("#check_date").css("color", "red");
                    err_start_date = false;
                } else if (dob_val_month > 12 || dob_val_year > new Date().getFullYear()) {
                    $("#check_date").show();
                    $("#check_date").focus();
                    $("#check_date").css("color", "red");
                    err_start_date = false;
