                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header" style="background-color:white">
                                            <h3 class="card-title" style="font-size:20px;"><b>DAILY REPORT OF: </b>

                                            </h3>
                                            <button type="button" class="btn btn-info text-dark  ml-3"
                                                onclick="history.back();" style="float:right;">Back</button>
                                            {{-- <button type="button" class="btn btn-danger text-dark"
                                                onclick="get_pdf('table_daily' , 'Daily Report Of:  →' , '#daily_title')"
                                            ...
                                            {{-- <button type="button" class="btn btn-danger text-dark mr-3"
                                                onclick="get_pdf_all('table_daily' , 'Daily Report Of:  → ' , '#daily_title','table_monthly' , 'Monthly Report Of:  → ' , '#monthly_title' )"
                                            ...
                                            <div class="row">
                                                <div class="col-12" id="view_daily">
                                                    <div class="table-responsive" id="daily">
                                                        ...
                                                        <table class="table table-hover  mb-0" id="" style="padding:20px;">
                                                            <thead>
                                                                <tr>
                                                                    <th
                                                                        style="color:white;background-color:rgb(10, 153, 247);">
                                                                        Name</th>
                                                                    <th
                                                                        style="color:white;background-color:rgb(10, 153, 247);">
                                                                        Group Name</th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td style="padding:10px;font-size:15px;">
                                                                      {{$item->first_name}}  </td>
                                                                    <td style="color:;padding:10px;font-size:15px;">
                                                                    {{$item->team_member_type}}<b></b></td>
                                                                    <td style="color:; padding:10px;font-size:15px;">
                                                                        {{$item->is_active}}<b></b></td>
                                                                    <td style="color:;padding:10px;font-size:15px;">
                                                                    <a href="{{url('employer/manageteammember/team_members_view/report_show/'.$item->ID.'/'.$item->first_name)}}" style="color:brown"><i class="fa fa-calendar-plus-o" aria-hidden="true"></i></a><b></b></td>
                        ...
                        <div class="tab-pane" id="message-2" role="tabpanel" aria-labelledby="message-tab-2">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header" style="background-color:white">
                                            <h3 class="card-title" style="font-size:20px;"><b>MONTHLY REPORT OF:  </b>
                                            </h3>
                                            <button type="button" class="btn btn-warning text-dark ml-3"
                                                onclick="history.back();" style="float:right;">Back</button>
                                            <button type="button" class="btn btn-danger text-dark"
                                                onclick="get_pdf('table_monthly' , 'Monthly Report Of:  → ' , '#monthly_title')"
                                                style="float:right;">PDF Separate</button>
                                            {{-- <button type="button" class="btn btn-success text-dark  ml-3"
                                                onclick="location.reload();" style="float:left;border-radius:10px;">↻</button> --}}
                                            <button type="button" class="btn btn-danger text-dark mr-3"
