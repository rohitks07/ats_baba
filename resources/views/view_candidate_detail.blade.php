        ...
        <div class="row">
            ...
            <div class="col-md-6" style="float:left;">
                ...
                <table class="table table-sm">
                            <thead>
                            <tr>
                            <th>Job Title</th><th>Company Name</th><th>Start Date</th><th>End Date</th><th>City</th><th>country</th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach($toReturn['experience'] as $experience)
                            <tr><th>{{$experience['job_title']}}</th>
                ...
                <div class="card card-border card-primary">
                    ...
                    @if(@$toReturn['job_details'])
                        <table class="table table-sm">
                            <thead>
                            <tr>
                            <th>Job Title</th><th>Job Code</th><th>Owner Id</th><th>Client Name</th><th>City</th><th>State</th>
                            </tr>
                            </thead>
                            <tbody>
                            ...
                            // exit;
                            ?>
                            <tr><th>{{$toReturn['job_details'][$key]['job_title']}}</th>
                ...
                <div class="card card-border card-primary">
                    ...
                    @if(@$toReturn['academic']) 
                        <table class="table table-sm">
                            <thead>
                            <tr>
                            <th>Degree Title</th><th>major</th><th>Institude</th><th>Country</th><th>City</th><th>Completion_year</th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach($toReturn['academic'] as $academic)
                            <tr><th>{{$academic['degree_title']}}</th>
