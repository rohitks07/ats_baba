                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row" >
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-4" id="dels" >
                                                ...
                                                <input type="text" id="skypeid" onblur="rate()" placeholder="Skype ID" name="skypeid" required>
                                        </div><!-- end of col -->
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-4" id="dels">
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-4" id="dels" >
                                                ...
                                                <input type="date" id="visaexpiry" onblur="rate()" placeholder="US Visa Expiry" name="visaexpiry" required>
                                        </div><!-- end of col -->
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-4" id="dels" style="background-color:;">
                                               ...
                                               <div class="col-sm-12 col-md-6 col-lg-4" id="dels" >
                                                ...
                                                <input type="text" id="passportno" onblur="rate()" placeholder="Passport No" name="passportno" required>
                                        </div><!-- end of col -->
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-4" id="dels">
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-4" id="dels" >
                                                ...
                                                <input type="text" id="linkedinid" onblur="rate()" placeholder="Linkedin Id" name="linkedinid" required>
                                        </div><!-- end of col -->
