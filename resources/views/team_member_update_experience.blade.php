                ...
                <div class="card">
                    ...
                    <div class="card-body" style="border: 1px #B0B0B0 solid;">
                        ...
                        <div class="row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <input type="text" id="job_title" name="job_title" placeholder="Job Title"
                                                value="{{$exp->job_title}}" class="form-control" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="text" id="company_name" name="company_name"
                                                placeholder="Company Name" value="{{$exp->company_name}}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="text" id="start_date" name="start_date"
                                                placeholder="start Date" value="{{$exp->start_date}}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="text" id="end_date" name="end_date" placeholder="end_date"
                                                value="{{$exp->end_date}}" class="form-control date-picker1"
                                                style="font" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="text" id="city" name="city" placeholder="City"
                                                class="form-control" value="{{$exp->city}}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4">
                                            <select id="country" name="country" class="form-control">
                                                <option value="{{$exp->country}}" selected>{{$exp->country}}</option>
                            ...
                            <center>
                                <button type="submit" class="btn btn-primary ml-3" onclick="validation()">Submit</button>
                            </center>
                        </div>
                    </div>
                </div>
