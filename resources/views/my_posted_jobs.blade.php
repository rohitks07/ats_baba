                                ...
                                <div class="col-md-12 col-sm-12 col-12">
                                    <table class="table table-bordered table-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%; overflow-x:scroll;">
                                        ...
                                        <tbody id="myTable">
                                            ...
                                            <div class="modal fade" id="mailModal{{$posted_job['ID']}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form class="cmxform form-horizontal tasi-form" action="{{url('employer/posted_jobs/email_add')}}" method="post">
                                                                @csrf
                                                                <input type="hidden" class="form-control" id="candidate_id" name="candidate_id" value="{{$posted_job['ID']}}" required>
