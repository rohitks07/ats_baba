                     ...
                     <div class="row">
                         ...
                         <div class="col-lg-6 col-md-6 col-sm-6">
                              ...
                              <div class="form-group row">
                                ...
                                <option selected>{{$toReturn['post_job']->country}}</option>
                                ...
                                <option value="AK" selected>{{$toReturn['post_job']->state}}</option>
                                ...
                                <input type="text" name="city" id="city" placeholder="City" maxlength="150" style="width:44%;border: 1px solid #bbb8b8;" value="{{$toReturn['post_job']->city}}">
                                    <br>
                            ...
                            <!--end of location-->
                             ...
                             <div class="form-group row">
                                ...
                                <option selected>{{$toReturn['post_job']->pay_min}}-</option>
