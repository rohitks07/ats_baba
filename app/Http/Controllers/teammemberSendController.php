...
// return $toReturn;
    ...
    public function send_report(Request $Request)
    {
        ...
        if (($Request->sendfile_doc !== "") && ($Request->sendfile_doc !== null)) {
            ...
            $data = array('send_report' => $send_report, 'sender_email' => $sender_email, 'sender_name' => $sender_name, 'toReturn' => $toReturn);
