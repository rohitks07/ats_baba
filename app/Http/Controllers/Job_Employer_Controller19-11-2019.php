...
// above this comment is permission for org profile
    ...
    public function assign_job($id="")
    {
     $toReturn=array();
        ...
        // return $toReturn['team_member_list'];
        // exit;   
    ...
    public function meetingshow(){
        ...
        return view('calendar',compact('toReturn','data'));
    }
    ...
    {
        $toReturn['application_detail']= Tbl_seeker_applied_for_job::where('',$toReturn['application_detail']['seeker_ID'])->first();
        // $toReturn['forward_candeate']= tbl_forward_candidate_documents::where('ID',$id)->first();
